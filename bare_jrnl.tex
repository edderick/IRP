...
as header compression and packet fragmentation. 6LoWPAN can be statelessly
translated into IPv6 in an inexpensive bridge or gateway. 

\subsubsection{ZigBee}
ZigBee is a set of protocols that run over 802.15.4. It is designed to be a
