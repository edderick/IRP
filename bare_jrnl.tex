...
In the new environment of the IoT, we have seen suggestions for new lightweight
encryption algorithms proposed, for example Hummingbird \cite{Sion2010}.
However, as these algorithms have not received the same level of public
scrutiny of the AES and RSA, it is safer to stick with these cryptographic
